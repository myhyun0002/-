...
public class ChattingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    FirebaseDatabase database = FirebaseDatabase.getInstance("https://wither-chat-default-rtdb.firebaseio.com/");
...
//            chatting_room_num_string = String.valueOf(room_database.getId());
        ...
        Intent intent = getIntent();
        String chatting_room_num_string = intent.getStringExtra("chatting_room_num_string");
        ...
        chatroom = chatting_room_num_string;
