...
public class MakeDatabase implements Parcelable {
    ...
    public int getMarkerIcon_int(String meeting_category){
        if(meeting_category.equals("축구") ){
            return(R.drawable.category_ic_football);
        }else if(meeting_category.equals("넷플릭스")){
            return(R.drawable.category_ic_netflix);
        }else if(meeting_category.equals("담배")){
            return(R.drawable.category_ic_cigarette);
        }else if(meeting_category.equals("공부")){
            return(R.drawable.category_ic_study);
        }else if(meeting_category.equals("야구")){
            return(R.drawable.category_ic_baseball);
        }else if(meeting_category.equals("카페")){
            return(R.drawable.category_ic_cafe);
        }else if(meeting_category.equals("영화")){
            return(R.drawable.category_ic_movie);
        }else if(meeting_category.equals("여행")){
